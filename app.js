...
const reserveQuestion = {
  ...
  options: ["شكر لأنه قبل الحجر وحمى سرها", "شكر على منحه إياها فرصة للشعور بالأمومة قبل موتها", "شكر على محاولته إنقاذها رغم استحالة الأمر
", "شكر لأنه لم يتركها وحيدة حتى النهاية"],
  correct: 1
};
